...
from ff_model import ParserModel, minibatches, load_and_preprocess_data, AverageMeter, train


if __name__ == "__main__":
    """
    Main codeblock contains slightly modified variation on code provided by course instructors 
    """
