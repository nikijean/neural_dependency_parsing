...
"""
Note: all of the code inside the parser_utils module was provided by XCS224N Instructors
The goal of this code is to extract a feature vector representing the current state of the parse, as presented in 
Chen and Manning, 2014, https://nlp.stanford.edu/pubs/emnlp2014-depparser.pdf
Feature vector is a list of tokens that can be represented as integers
"""
