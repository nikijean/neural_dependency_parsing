class PartialParse(object):
    def __init__(self, sentence):
        ...
        #                         last element of the list. Root token represented as "ROOT"
        self.stack = ["ROOT"]
...
def test_step(name, transition, stack, buf, deps,
    ...
    ### Note: this function's code provided by XCS224N Instructors
...
class DummyModel(object):
    ### Note: this class's code provided by XCS224N Instructors
